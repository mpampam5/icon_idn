      ...
      <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/referral/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
...
$(document).ready(function() {
      $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      {
        ...
        var t = $("#table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?=base_url()?>backend/referral/json", "type": "POST"},
            columns: [
                {
                    "data": "id_referral",
                    "orderable": false
                ...
                render:function(data,type,row,meta)
                {
                    return '<a class="text-info" href="<?=base_url()?>backend/paket/detail/'+row.id_paket+'.html" target="_blank"><i class="fa fa-link"></i> '+data+'</a>';
                }
                },
								{"data":"created"},
								{"data":"is_active",
                  ...
                  {
                    if (data==1) {
                      return '<span class="text-info"> Aktif</span>';
                    }else {
