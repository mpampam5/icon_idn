      ...
      <div class="col-lg-12 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/tb_member/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
        ...
        var t = $("#table").dataTable({
            ...
            columns: [
                ...
                render:function(data,type,row,meta)
                {
                  ...
                  render:function(data,type,row,meta)
                  {
                    return '<span class="text-info">'+row.nik+'</span>&nbsp;|&nbsp;<span class="text-info">'+data+'</span>';
                  }
                },
								{"data":"email"},
								{"data":"telepon"},
