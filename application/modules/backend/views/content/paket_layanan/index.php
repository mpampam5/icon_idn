      ...
      <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/paket_layanan/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
...
$(document).ready(function() {
      $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      {
        ...
        var t = $("#table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?=base_url()?>backend/paket_layanan/json", "type": "POST"},
            columns: [
                {
                    "data": "id_layanan",
                    "orderable": false
                ...
                {
                  if (row.harga_per_kepala!=1) {
                    return 'Rp. '+data;
                  }else {
                    return 'Rp. '+data+' /kepala';
                  }
                }
                },
								{"data":"kategori",
                ...
                {"data":"harga_per_kepala","visible":false},
            ],
            order: [[0, 'desc']],
